...
if (!isset($_SESSION['Emp_Num']) || !isset($_SESSION['role'])) {
    session_destroy();
    header("Location: /clothes/index.php?redirect=staff");
    exit();
}
?>
<html>
    ...
    <section>
        <div class="container" style="margin: 20px auto">
            <div class="shadow bg-white " style="padding:0.15rem 1rem!important">
                ...
                <a href="/clothes/staff/" class="text-info">人事薪資管理</a>
            </div>
        </div>
    </section>
    <section>
                ...
                <div class="row">
                    <div class="col-sm" style="margin:auto">
                        <div style="margin: auto;max-width:90%;width:250px">
                            <button type="button" class="btn btn-outline-primary btn-block" onclick="window.open('departmentManage.php','_self')">C01 部門資料維護</button>
                            <button type="button" class="btn btn-outline-success btn-block" onclick="window.open('employeeManage.php','_self')">C02 員工資料維護</button>
                            <!--<button type="button" class="btn btn-outline-warning btn-block" onclick="window.open('purchase.php','_self')">C03 薪資資料維護</button>-->
