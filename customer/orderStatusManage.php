...
$permission  = checkPermission(null, 'A06');
if ($permission < 1) {
    ...
    <section>
        <div class="container" style="margin: 20px auto">
            <div class="shadow bg-white " style="padding:0.15rem 1rem!important">
                ...
                <a href="/clothes/customer/orderStatusManage.php" class="text-info">訂單狀態維護</a>
            </div>
        </div>
    </section>
    <section>
        ...
        $(function() {
            opt_order = {
                ...
                "columns": [{
                    ...
                    {
                        "render": function(data, type, row, meta) {
                            data = "<button type=\"button\" class=\"btn btn-warning \" onclick=\"window.open('orderStatusInfo.php?id=" + row.Order_Num + "','_self');\" style=\"margin:1px\">狀態更新</button>";
